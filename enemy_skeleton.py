...
skeleton_data_list = [
    ...
    {'speed': 2.0, 'hp': 0.15* 100,'damage':0.015*100},
    {'speed': 2.0, 'hp': 0.2*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.25*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.25*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.3*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.3*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.35*100, 'damage': 0.02*100},
    {'speed': 2.0, 'hp': 0.35* 100,'damage':0.025*100},
    {'speed': 3.0, 'hp': 0.4* 100,'damage':0.03*100},
    {'speed': 3.0, 'hp': 0.4* 100,'damage':0.03*100},
    {'speed': 3.0, 'hp': 0.5* 100,'damage':0.03*100},
    {'speed': 3.0, 'hp': 0.5*100, 'damage': 0.035*100},
